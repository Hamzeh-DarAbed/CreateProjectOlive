...
{
    public class AdminUserIntegrationTest : IClassFixture<CustomWebApplicationFactory>, IClassFixture<Mongo2GoFixture>
    {
        ...
        public AdminUserIntegrationTest(CustomWebApplicationFactory factory, Mongo2GoFixture mongoDb)
        {
            _mongoDb = mongoDb;
            _factory = factory;
        }
        ...
        // [Theory]
        // [InlineData("api/AdminUser")]
        // public async Task CreateAdminUser_Returns200(string url)
        // {
        //     _mongoDb.SeedData();
        ...
        [Theory]
        [InlineData("api/AdminUser")]
        public async Task CreateAdmin_Returns201(string url)
        {
            ...
            HttpContent HttpContent = new StringContent(JsonConvert.SerializeObject(addAdminDto), Encoding.UTF8, "application/json");
            // Arrange
            HttpClient client = _factory.InjectMongoDbConfigurationSettings(_mongoDb.ConnectionString, _mongoDb.Database.DatabaseNamespace.DatabaseName).CreateClient();
            ...
            // _mongoDb.Database.DropCollection("ApplicationUser");

            _mongoDb.Database.DropCollection("ApplicationUser");

            // Assert
            Assert.Equal("200", response.ToString());
        }
